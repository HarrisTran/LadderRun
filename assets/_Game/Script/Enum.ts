...
export enum ENUM_GAME_EVENT {
    ...
    UPDATE_GAME_TICK = 'UPDATE_GAME_TICK',

    CLAIM_MAGNET_BOOSTER = 'CLAIM_MAGNET_BOOSTER',
    CLAIM_SHIELD_BOOSTER = 'CLAIM_SHIELD_BOOSTER',
    CLAIM_SPEED_BOOSTER = 'CLAIM_SPEED_BOOSTER',
